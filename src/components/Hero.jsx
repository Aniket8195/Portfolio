        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              I build scalable and high-performance applications with clean architecture and modern web technologies. 
              My expertise includes designing robust full-stack solutions, leveraging microservices, caching strategies, 
              and cloud technologies like AWS and Docker to ensure seamless scalability.
            </p>
            <div className="flex justify-center lg:justify-start space-x-4 mb-8">
              <a
                href="https://github.com/Aniket8195"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/aniketpatil951"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
              ...
              <a
                href="mailto:9518aniket@gmail.com"
                className="p-3 rounded-full bg-white/80 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-800 transition-colors duration-300 shadow-lg hover:shadow-xl"
